...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        pickerReason = [[UIPickerView alloc] initWithFrame:CGRectMake(50, 80, 180, 40)];
        pickerReason.showsSelectionIndicator = YES;
//        pickerReason.backgroundColor=[UIColor redColor];
        ...
        btnChunk.frame = CGRectMake(75, 210, 40, 30);
        ...
        btnCancel.frame = CGRectMake(160, 210, 40, 30);
