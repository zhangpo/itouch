...
@class ZCABPickerView;

@protocol ABPickerViewDelegate

- (void)pickerDidFinishSelection:(ZCABPickerView *)picker;
- (void)pickerDidCancelSelection:(ZCABPickerView *)picker;
- (void)pickerDidChangedSelection:(ZCABPickerView *)picker;

@end

@interface ZCABPickerView : UIView<UIPickerViewDelegate,UIPickerViewDataSource>{
