...
- (void)showInfo:(NSDictionary *)info{
        ...
        NSMutableArray *aryOrder = self.selectArray;
        int countFood = 0;
        for (NSMutableDictionary *dicOrder in aryOrder) {
            if ([[dicOrder objectForKey:@"PCODE1"] isEqualToString:[info objectForKey:@"PCODE1"]]&&[[dicOrder objectForKey:@"PRODUCTTC_ORDER"] isEqualToString:[info objectForKey:@"PRODUCTTC_ORDER"]]) {
